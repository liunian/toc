...
(function() {
  ...
  function createToc(boxId) {
    ...
    var cssTexts = '.tocBox{position:fixed;top:200px;right:10px;margin-top:30px !important;}.tocBox .toc-show{display:block !important;}.tocBox .tocBd{display:none;padding:5px 10px;min-width:200px;max-height:500px;border:1px solid rgba(0, 0, 0, .2);border-radius:2px;background:#fff;overflow:auto;}.tocBox a{text-decoration:none;}.tocBox ul{margin:0 !important;padding:0 !important;list-style:none;}.tocBox li ul{margin-left:20px !important;}.tocBox button{position:absolute;top:-20px;right:0;font-size:12px;line-height:1.2}'
